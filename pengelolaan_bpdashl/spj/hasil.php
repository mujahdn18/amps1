  ...
  <div style="text-align: center; line-height: 1;">
    <br>
        ...
        <?php
          ...
          $tdate=$_POST['todate'];
        ?>
        <h6 align="center" style="color:black; font-family: times new roman;" > <b>LAPORAN DATA PERTANGGUNG JAWABAN DARI TANGGAL <?php echo tgl_indo($fdate)?> S/D <?php echo tgl_indo($tdate)?></b> </h6>
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php                    
                    ...
                    INNER JOIN tb_pejabat ON tb_spj.id_pejabat = tb_pejabat.id_pejabat
                            where date(tgl_surat_spj) between '$fdate' and '$tdate'
                            ";                                 
