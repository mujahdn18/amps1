                        ...
                        while($data = mysqli_fetch_array($sql_spj)) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="cetak.php?id=<?=$data['id_spj']?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-print"> Kuitansi</i></a>                
                                    <a href="cetak_2.php?id=<?=$data['id_spj']?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-print"> Surat Pernyataan</i></a>
                                    <a href="cetak_3.php?id=<?=$data['id_spj']?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-print"> Rincian Biaya</i></a>
                                </td> 
                            </tr>
                    <?php
                    }                    
