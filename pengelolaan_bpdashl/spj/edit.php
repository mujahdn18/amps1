...
?>
    ...
    <div class="box">
        <h1>SPJ</h1>
            <h4>
                <small>Edit Data Surat Pertanggung Jawaban</small>
                ...
                ?>
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_surat_spj" id="no_surat_spj" value="<?=$data['no_surat_spj']?>" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mak" id="mak" value="<?=$data['mak']?>" class="form-control" required>
                        </div>    
                        <div class="form-group">
                            <label for="u_harian">Uang Harian</label>
                            <input type="number" name="u_harian" id="u_harian" value="<?=$data['u_harian']?>" class="form-control" required>
                        </div>  
                        <div class="form-group">
                            <label for="u_transportasi">Uang Transportasi</label>
                            <input type="number" name="u_transportasi" id="u_transportasi"  value="<?=$data['u_transportasi']?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="u_penginapan">Uang Penginapan</label>
                            <input type="number" name="u_penginapan" id="u_penginapan" value="<?=$data['u_penginapan']?>" class="form-control" required>
                        </div> 
                        <div class="form-group">
                            <label for="tgl_surat">Tanggal Surat</label>
                            <input type="date" name="tgl_surat" id="tgl_surat" value="<?=$data['tgl_surat_spj']?>" class="form-control" required>
                        </div>                        
