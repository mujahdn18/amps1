    ...
    <tbody>
      <tr>
        <td style="width: 100.0000%;">
          <div style="text-align: center;"><span style="font-family: Tahoma, Geneva, sans-serif; font-size: 18px;"><strong>DATA SPJ UP</strong></span></div>
        </td>
      </tr>
    </tbody>
  </table>
...
<table border="1" width="100%">
            ...
            $id = @$_GET['id'];               
                    $no = 1;                                 
                    $sql_spjup = mysqli_query($con, "SELECT * FROM tb_spjup where id_spjup = '$id'") or die (mysqli_error($con));                    
