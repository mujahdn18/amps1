    ...
    <tbody>
      <tr>
        <td style="width: 100.0000%;">
          <div style="text-align: center;"><span style="font-family: Tahoma, Geneva, sans-serif; font-size: 18px;"><strong>REKAPITULASI TUNJANGAN KINERJA</strong></span></div>
        </td>
      </tr>
    </tbody>
  </table>
...
<table border="1" width="100%">
            ...
            <?php 
                            $a = 0;
                            $sql = mysqli_query($con, "SELECT * FROM tb_absen ORDER BY id_absen") or die (mysqli_error($con));                    
