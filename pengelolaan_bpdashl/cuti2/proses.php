...
if(isset($_POST['add'])) {
    ...
    mysqli_query($con, "UPDATE tb_cuti SET tgl_cuti='$tgl_cuti', perihal='$perihal', id_pegawai='$id_pegawai', jangka_hari='$jangka_hari', dari_tgl='$dari_tgl', sampai_tgl='$sampai_tgl', keterangan='$keterangan' WHERE id_cuti='$id'") or die (mysqli_error($con));
    echo "<script>window.location='data.php'</script>";
}
?>