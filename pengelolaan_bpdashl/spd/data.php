    ...
    <div class="box">
        ...
        <h4>
            ...
            <div class="pull-right">
                ...
                <a href="add.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"> Tambah SPD </i></a>
            </div>
        </h4>
                        ...
                        while($data = mysqli_fetch_array($sql_spd)) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="edit.php?id=<?=$data['id_spd']?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
                                    <a href="del.php?id=<?=$data['id_spd']?>" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                    <a href="cetak.php?id=<?=$data['id_spd']?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-print"></i></a>                
                                </td> 
                            </tr>
                        <?php
                        }
