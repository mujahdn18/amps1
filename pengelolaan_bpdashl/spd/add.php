...
?>
    ...
    <div class="box">
        <h1>SPD</h1>
            <h4>
                <small>Tambah Data Surat Perjalanan Dinas</small>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_surat_spd" id="no_surat_spd" value="S./BPDASHL.Brt-1//SPD/" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
