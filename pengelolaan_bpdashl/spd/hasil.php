  ...
  <div style="text-align: center; line-height: 1;">
    <br>
        ...
        <?php
          ...
          $tdate=$_POST['todate'];
        ?>
        <h6 align="center" style="color:black; font-family: times new roman;" > <b>LAPORAN DATA SURAT PERJALANAN DINAS DARI TANGGAL <?php echo tgl_indo($fdate)?> S/D <?php echo tgl_indo($tdate)?></b> </h6>
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php                    
                    ...
                    INNER JOIN tb_ppk ON tb_spd.id_ppk = tb_ppk.id_ppk
                            where date(tgl_surat_spd) between '$fdate' and '$tdate'
                            ";                                 
