  ...
  <div style="text-align: center; line-height: 1;">
    <br>
        ...
        <?php
          ...
          $tdate=$_POST['todate'];
        ?>
        <h6 align="center" style="color:black; font-family: times new roman;" > <b>LAPORAN DATA SURAT PERINTAH TUGAS DARI TANGGAL <?php echo tgl_indo($fdate)?> S/D <?php echo tgl_indo($tdate)?></b> </h6>
